...
const educationList = [
  ...
  },
  {
    ...
    tags: ['Computer Network', 'Linux Sysadmin', 'MikroTik & Cisco', 'Hardware']
  }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 items-stretch">
        {educationList.map((item, index) => (
          <motion.div
            ...
            className="p-6 sm:p-7 rounded-2xl bg-[#0d0d0f]/60 border border-white/10 backdrop-blur-md relative overflow-hidden flex flex-col justify-between group shadow-xl"
          >
            <div>
              {/* Badge Periode (Pil Widget Hijau) */}
              ...
              <div className="flex items-start gap-3.5 sm:gap-4 mb-4">
                ...
                {/* Judul & Institusi (Judul Selalu Putih) */}
                <div>
