...
export interface MagicBentoProps {
    ...
    enableTilt?: boolean;
    glowColor?: string; // Format RGB string, misal: "16, 185, 129"
    clickEffect?: boolean;
...
const DEFAULT_GLOW_COLOR = '16, 185, 129'; // Emerald RGB
const MOBILE_BREAKPOINT = 768;

const defaultCardData: BentoItem[] = [
    { id: 1, title: 'Analytics', description: 'Track user behavior', label: 'Insights' },
    { id: 2, title: 'Dashboard', description: 'Centralized data view', label: 'Overview' },
    { id: 3, title: 'Collaboration', description: 'Work together seamlessly', label: 'Teamwork' },
    { id: 4, title: 'Automation', description: 'Streamline workflows', label: 'Efficiency' },
    { id: 5, title: 'Integration', description: 'Connect favorite tools', label: 'Connectivity' },
    { id: 6, title: 'Security', description: 'Enterprise-grade protection', label: 'Protection' }
];
        ...
        <>
            ...
            <div className={`card-grid bento-section ${className}`} ref={gridRef}>
                {items.map((card, index) => {
                    ...
                    return (
                        <div key={card.id || index} className={baseClassName} style={cardStyle}>
                            {cardInnerContent}
                        </div>
                    );
                })}
